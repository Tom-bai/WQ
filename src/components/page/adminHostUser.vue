            ...
            <el-col :span="24">
                <el-card shadow="hover">
                    ...
                    >
                        ...
                        <!-- <el-table-column prop="site" label="原始链接" align="center"></el-table-column> -->
                        <el-table-column prop="gmtCreate" width="200" label="添加时间" align="center"></el-table-column>
                        <el-table-column label="状态" width="100" align="center">
                            <template slot-scope="scope">
                                <el-tag type="success" v-if="scope.row.state == 0">正常</el-tag>
                                <el-tag type="danger" v-else-if="scope.row.state == 1">已封</el-tag>
                            </template>
                        </el-table-column>
