            ...
            <el-col :span="24">
                    ...
                    <el-col :span="8">
                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                            <div class="grid-content grid-con-1">
                                ...
                                <div class="grid-cont-right">
                                    <div class="grid-num">{{childcount.account}}</div>
                                    <div>会员数量</div>
                                </div>
                            </div>
                        </el-card>
                    ...
                    <el-col :span="8">
                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                            <div class="grid-content grid-con-4">
                                ...
                                <div class="grid-cont-right">
                                    <div class="grid-num">{{childcount.goldCoin}}</div>
                                    <div>剩余金币</div>
                                </div>
                            </div>
                        </el-card>
                    ...
                    <el-col :span="8">
                        <el-card shadow="hover" :body-style="{padding: '0px'}">
                            <div class="grid-content grid-con-3">
                                ...
                                <div class="grid-cont-right">
                                    <div class="grid-num">{{childcount.days}}天</div>
                                    <div>有效时间</div>
                                </div>
                            </div>
                        </el-card>
                ...
                <el-card shadow="hover">
                    <div slot="header" class="top-flex">
                        <span>会员管理</span>
                        <el-button type="primary" icon="el-icon-circle-plus-outline" plain @click="onUserAddvip">新增会员</el-button>
                    </div>
                    <div class="handle-box">
                        ...
                        >批量删除</el-button> -->
                        <!-- <el-select v-model="query.address" size="null" placeholder="地址" class="handle-select mr10">
                    ...
                    >
                        ...
                        <el-table-column prop="type" width="120" label="账户类型">
                        ...
                        <el-table-column label="管理操作" width="200" align="center">
                            <template slot-scope="scope">
                                <el-button
                                    type="text"
                                    icon="el-icon-edit"
                                    @click="onUserEditvip(scope.$index, scope.row)"
                                >编辑</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
...
export default {
    ...
    methods: {
        onUserAddvip () {
            this.$router.push('/userAddvip')
        },
        onUserEditvip(index, row) {
            this.$router.push({
                path:'/userEditvip',
                query:{
                    id:row.id,
