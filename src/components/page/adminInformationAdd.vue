        ...
        <el-row :gutter="20">
            <el-col :span="24">
                <el-card>
                    ...
                    <div class="container">
                        <div class="form-box">
                            <div class="title">模板图(414*696)</div>
                            <el-upload
                                class="upload-demo"
                                :action="action"
                                :headers="headers"
...
import { adminInformationInfotemp,adminInformationEdit,adminPostInfotemp ,adminInfotempGet} from '../../api/index';
export default {
    ...
    methods: {
        ...
        postData () {
            ...
            adminPostInfotemp(data).then(res => {
                if (res.code === 0) {
                    that.$message.success(res.data)
                    that.resetForm()
                } else {
